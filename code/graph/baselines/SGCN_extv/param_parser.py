...
def parameter_parser():
    ...
    parser.add_argument("--edge-path",
                        nargs="?",
                        default="./input/tr_edge_hr_att_083121.csv",
	                help="Edge list csv.")

    parser.add_argument("--features-path",
                        nargs="?",
                        default="./input/tr_node_fe_att_083121.csv",
	                help="Edge list csv.")

    parser.add_argument("--embedding-path",
                        nargs="?",
                        default="./output/embedding/lux_sgcn.csv",
	                help="Target embedding csv.")

    parser.add_argument("--regression-weights-path",
                        nargs="?",
                        default="./output/weights/lux_sgcn.csv",
	                help="Regression weights csv.")

    parser.add_argument("--fc-weights-path",
                        nargs="?",
                        default="./output/fc_weights/lux_sgcn.csv",
	                help="FC weights csv.")
