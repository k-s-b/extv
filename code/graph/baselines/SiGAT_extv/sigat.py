...
parser.add_argument('--dataset', default='tr_edgelist', help='Dataset')
parser.add_argument('--dim', type=int, default=20, help='Embedding Dimension')
parser.add_argument('--fea_dim', type=int, default=32, help='Feature Embedding Dimension')
parser.add_argument('--batch_size', type=int, default=500, help='Batch Size')
parser.add_argument('--dropout', type=float, default=0.1, help='Dropout k')
...
def run( dataset='bitcoin_alpha', k=2):
    ...
    fpath = os.path.join(OUTPUT_DIR, 'embedding-{}-{}-{}_{}.npy'.format(dataset, k, str(EMBEDDING_SIZE1), str(epoch-1)) )
