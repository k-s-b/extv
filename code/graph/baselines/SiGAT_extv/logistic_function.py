...
def common_logistic(dataset, k, embeddings, model):
    ...
    pr, re, f1, _ = precision_recall_fscore_support(test_y, pred, average='macro')
...
def main():
    dataset = 'tr_edgelist'
    pos_ratio, accuracy, f1_score0, f1_score1, f1_score2, auc_score = logistic_embedding9(k=1, dataset=dataset, epoch=200, dirname='sigat')
